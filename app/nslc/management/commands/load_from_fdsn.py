...
Command run without any options will give default URL
    http://service.iris.edu/irisws/fedcatalog/1/
        ...
        &level=channel
        &net=AE,AG,AK,AV,AZ,BC,BK,CC,CE,CI,CN,C0,C8,CO,CU,CW,CY,EP,ET,GS,GM,HV,IE,IU,IW,JM,KY,LB,LD,LI,LM,MB,MU,MX,N4,NA,NC,NE,NM,NN,NP,NV,NW,NX,NY,O2,OH,OK,OO,PB,PE,PO,PQ,PR,PT,PY,RB,RC,RE,RV,SB,SC,SE,SN,TD,TR,TX,UM,UO,US,UU,UW,WR,WU,WW,WY
        &sta=*
        &cha=EN?,HN?,?H?
        &loc=*
        &minlat=12.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ALLOWED_NETWORKS = [
            ...
            "RB", "RC", "RE", "RV", "SB", "SC", "SE", "SN", "TD", "TR", "TX", "UM", "UO", "US",
            "UU", "UW", "WR", "WU", "WW", "WY"
        ]
