...
class ChannelFilter(filters.FilterSet):
    ...
    station = CharInFilter(field_name='station', lookup_expr='in')
    sta_search = filters.CharFilter(field_name='station',
                                    lookup_expr='iregex')
    location = filters.CharFilter(field_name='location')
    loc_search = filters.CharFilter(
        field_name='location', lookup_expr='iregex')
